# Engineering Handover Notes: Legacy Shop

> Last updated: 2026-06-10 | Maintained by: Engineering team lead on this project
...
| Decision | Why | Date |
|----------|-----|------|
| [FILL IN] | [FILL IN] | 2026-06-10 |

## Current State
<!-- What is the exact current state of the engineering work? -->
[FILL IN]
...
- The engineering work is at: [FILL IN current state]
