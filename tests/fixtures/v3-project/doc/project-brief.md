# Project Brief: Legacy Shop

> Created: 2026-06-10 | Maintained by: Project Manager / Team Lead
...
| Field | Value |
|-------|-------|
| **Level** | Level 2 (Standard Application) |
| Reference examples | SaaS platforms, marketplaces, CRM systems, mobile applications |
| Recommended team size | 4-7 roles across 2-3 departments |
| Documentation required | Core doc/ set only |
