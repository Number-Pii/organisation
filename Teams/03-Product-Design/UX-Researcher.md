...
|---|---|---|
| User Research Studies | Lead | Execute |
| Usability Testing | Lead | Execute |
| Feature Validation | Researcher | Advise |
| Product Strategy | Research contributor | Advise |

## Approval Authority
- **Can approve:** Research plans, study methodologies
- **Needs approval from:** Lead Product Designer (research scope), CPO (research budget)
