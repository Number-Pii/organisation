...
|---|---|---|
| Consultancy Engagements | Practice lead | Approve (engagement scope) |
| Consultant Assignments | Resource allocator | Approve |
| Thought Leadership | Contributor | Execute |

## Approval Authority
- **Can approve:** Engagement scope, consultant assignments, deliverable standards
- **Needs approval from:** VP Sales & Consultancy (pricing, large engagements)
