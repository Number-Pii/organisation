# Design Handover Notes: Golden Sample

> Last updated: 2026-01-01 | Maintained by: Design team lead on this project
...
| Decision | Why | Date |
|----------|-----|------|
| [FILL IN] | [FILL IN] | 2026-01-01 |

## Current State
<!-- What is the exact current state of the design work? -->
[FILL IN]
...
- The design work is at: [FILL IN current state]
