...
# ── Frontmatter parser (shared, zero-dep) ─────────────────────────────────────
# The parser lives in scripts/lib/frontmatter.py; the re-export keeps the
# historical `from audit_skills import parse_frontmatter` import path working.

from lib.frontmatter import (  # noqa: E402, F401
    VALID_SIZE_CLASSES,
    parse_frontmatter,
    size_class_for,
)
