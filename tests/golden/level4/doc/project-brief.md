...
| Field | Value |
|-------|-------|
| **Level** | Level 4 (Large-Scale Engineering) |
| Reference examples | National platforms, government systems, financial systems, healthcare systems, distributed architectures |
| Recommended team size | Full team assignment from Teams/organisation.md |
| Documentation required | Core doc/ set plus architecture.md with decision records |
