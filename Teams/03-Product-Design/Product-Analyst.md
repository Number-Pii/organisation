...
|---|---|---|
| Feature Performance | Analyst | Advise |
| A/B Tests | Owner (setup, analysis) | Execute |
| Product Dashboards | Owner | Execute |
| Roadmap Decisions | Data provider | Advise |

## Approval Authority
- **Can approve:** Dashboard configurations, experiment designs
- **Needs approval from:** CPO (metric definitions), Senior PM (experiment scope)
