...
- `CLAUDE.md` is the source of truth; `GEMINI.md` is generated by `scripts/sync_ai_context.py` (see [CONTRIBUTING.md](CONTRIBUTING.md#keeping-claudemd-and-geminimd-in-sync))
