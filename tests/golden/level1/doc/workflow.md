...
## Quality Gates (Level 1: Simple Task)
...
<!-- This file is the plan. Live status belongs on the task board (GitHub
     Projects) and in branch handover entries, so parallel work never edits
     the same rows here. Stages 1 and 2 (Discovery, Planning) are mostly done
     at initialization; record remaining planning tasks under Stage 2. -->

### Stage 2: Planning (remaining tasks)
| # | Task | Owner | Type | Depends On |
|---|------|-------|------|------------|
| 1 | [FILL IN] | [FILL IN] | SEQUENTIAL | none |

### Stage 3: Implementation
| # | Task | Owner | Type | Depends On |
|---|------|-------|------|------------|
| 2 | [FILL IN] | [FILL IN] | SEQUENTIAL | #1 |

### Stage 4: Verification
<!-- The Quality Gates above are the exit criteria for this stage. -->
| # | Task | Owner | Type | Depends On |
|---|------|-------|------|------------|
| 3 | [FILL IN] | [FILL IN] | SEQUENTIAL | #2 |

### Stage 5: Deployment
| # | Task | Owner | Type | Depends On |
|---|------|-------|------|------------|
| 4 | [FILL IN] | [FILL IN] | SEQUENTIAL | #3 |

### Stage 6: Operations
<!-- Monitoring, support, and maintenance. Record the long-term owner in
     doc/handover/STATE.md before closure. -->
| # | Task | Owner | Type | Depends On |
|---|------|-------|------|------------|
| 5 | [FILL IN] | [FILL IN] | SEQUENTIAL | #4 |
