...
def main():
    ...
    if pull():
        ...
        print("Run the following command once in each project that uses this toolkit")
        print("to create any missing files. Existing files are never overwritten.")
        print()
        print("  python3 organisation/scripts/init_project.py \\")
        print('    --project-name "Your Project Name" \\')
        print("    --output-dir /absolute/path/to/your/project")
        print()
        print("  Replace 'Your Project Name' with your project's actual name.")
        print("  Replace the path with the root folder of your consuming project")
        print("  (the folder that contains your code, not the organisation toolkit).")
        print()
        print("  Example:")
        print("    python3 organisation/scripts/init_project.py \\")
        print('      --project-name "Client Portal" \\')
        print("      --output-dir /Users/yourname/projects/client-portal")
        print()
        if is_major:
