...
| Field | Value |
|-------|-------|
| **Level** | Level 1 (Simple Task) |
| Reference examples | Landing pages, internal tools, automation scripts, API integrations, technical documentation |
| Recommended team size | 1-3 roles (PM + 1-2 specialists) |
