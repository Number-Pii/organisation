...
3. **Acknowledge in plain text** at session start that you have read `CLAUDE.md`, `doc/project-brief.md`, `doc/version_control.md`, and `doc/handover/consolidated_handover.md`.
