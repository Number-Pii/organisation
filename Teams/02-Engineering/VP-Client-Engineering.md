...
|---|---|---|
| Client Website Build | Delivery lead / Assigner | Approve |
| Client Mobile App | Delivery lead / Assigner | Approve |
| Client Custom Software | Technical authority | Approve |
| Client Project Scoping | Estimation lead | Execute |
| Client Engineering Hires | Hiring manager | Approve |

## Approval Authority
- **Can approve:** Client project technical designs, team assignments, delivery timelines
- **Needs approval from:** CTO (architecture decisions), VP Sales (budget/scope changes)
