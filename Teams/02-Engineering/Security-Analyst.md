...
|---|---|---|
| Compliance Audits | Documentation / Evidence gathering | Execute |
| Vendor Assessments | Reviewer | Execute |
| Security Monitoring | Analyst | Execute |
| Security Training | Coordinator | Execute |
